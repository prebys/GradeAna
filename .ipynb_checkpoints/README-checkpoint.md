...
The program will automatically create 'page_1.png' and 'page_2.png' from these
pages.
  
The columns to be used are defined in define_plots.py file.  The file can have any name
...
v4.0	18-DEC-2025 E. Prebys   Made configuration file selectable.  Use indices instead
        ...
        19-DEC-2025 E. Prebys   Changed some naming conventions
